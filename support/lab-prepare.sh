...
function build_images() {
  ...
  oc create -f https://raw.githubusercontent.com/openshift-evangelists/summit17-cicd-lab/master/solutions/lab-5/coolstore-template.yaml -n openshift --as=system:admin
}
