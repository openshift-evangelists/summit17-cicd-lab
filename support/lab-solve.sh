...
# Deploy Dev
oc process -f https://raw.githubusercontent.com/openshift-evangelists/summit17-cicd-lab/master/solutions/lab-2/cart-template.yaml \
...
oc process -f https://raw.githubusercontent.com/openshift-evangelists/summit17-cicd-lab/master/solutions/lab-7/coolstore-bluegreen-template.yaml \
...
rm -rf /tmp/pipelines && \
    ...
    pushd /tmp/pipelines && \
    curl -sL https://raw.githubusercontent.com/openshift-evangelists/summit17-cicd-lab/master/solutions/lab-8/Jenkinsfile | sed "s|git url: .*|git url: '$CART_REPO'|g" > Jenkinsfile && \
    git add Jenkinsfile && \
...
curl -sL https://raw.githubusercontent.com/openshift-evangelists/summit17-cicd-lab/master/solutions/lab-4/cart-pipeline-scm.yaml | sed "s|uri: .*|uri: $PIPELINES_REPO|g" | oc create -f - -n dev
