...
oc process -f https://raw.githubusercontent.com/OpenShiftDemos/gogs-openshift-docker/master/openshift/gogs-persistent-template.yaml --param=SKIP_TLS_VERIFY=true --param=HOSTNAME=gogs-lab-infra.$HOSTNAME_SUFFIX --param=GOGS_VERSION=0.11.4 -n lab-infra | oc create -f - -n lab-infra
